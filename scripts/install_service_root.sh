...
# ZedinArkManager Systemd Service Installer (ROOT verzió)
# Ez a script létrehozza a systemd service fájlt ROOT felhasználóként
...
echo "[INSTALL] Systemd service telepítése ROOT felhasználóként..."
...
echo "[INSTALL] ✅ Service telepítve: $SERVICE_NAME (ROOT felhasználóként)"
...
echo ""
echo "⚠️  FIGYELEM: A service ROOT felhasználóként fut! Biztonsági kockázat!"
